...
String city ="$IP_Address/city/get/";
String orderDetails= "$IP_Address/detailsget/get/";
...
String refAccountApi= "$IP_Address/newaccounttime/get/";
String refBalance = "$IP_Address/totalbalance/get/";
String refRecoveryForm = "$IP_Address/newaccounttime/get/";
String refCity ="$IP_Address/newcitties/get/";
String refOrderDetails= "$IP_Address/newdetailsgettime/get/";
String refOrderMaster = "$IP_Address/newmastergettime/get/";
String refProductsApi = "$IP_Address/newproductget/get/";
String refShopDetails = "$IP_Address/newshopp1/get/";
